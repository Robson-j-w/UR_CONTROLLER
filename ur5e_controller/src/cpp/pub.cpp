...
int main(int argc, char **argv)
{
  ...
  std::shared_ptr<rclcpp::Node> node = rclcpp::Node::make_shared("move_function_client");
  rclcpp::Client<ur5e_interfaces::srv::Ur5eService>::SharedPtr client =
  ...
  {
    RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "complete: %d", result.get()->complete);
  } else {
